package com.example.tarea1_userpassword;
...
public class MainActivity extends Activity {
	...
	EditText cuadro_usuario, cuadro_password;//Cuadros de texto donde de ingresa la información de usuario
	...
	public void cambiarActividad(View v){
		...
		string_password = cuadro_password.getText().toString();//idem antetior
